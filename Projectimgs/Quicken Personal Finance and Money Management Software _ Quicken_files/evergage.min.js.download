...
(function configureEvergage() {
    try {
       Evergage.configure({
           ...
           trackerUrl: "https://quickeninc.us-7.evergage.com",
           siteConfigVersion: "39"
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"USD","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["customerId","emailAddress","profileId","sfmcContactKey"],"lastModified":1659720932700,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":false,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
    ...
    const sitemapConfig = {
        global: {
            onActionEvent: (actionEvent) => {
                const email = Evergage.resolvers.fromSelector(".sign-in-menu-top")().trim();
                if (email && email != 'Sign In') {
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.attributes = actionEvent.user.attributes || {};
                    actionEvent.user.attributes.name = email;
                }
                return actionEvent;
            },
            contentZones: []
        ...
        pageTypes: [
            // Homepage
            {
               ...
               //  isMatch: () => window.location.href == "stage.quicken.com" || window.location.pathname == "/",
                contentZones: [
                    { name: "homepage_main_headline", selector: "h1.display-discount" },
                    { name: "homepage_main_subhead", selector: "h6.display-discount" },
                    { name: "homepage_hero_footer", selector: "div.hero-section-footer" },
                    { name: "global_popup" } 
                ]
            },
            // Why Quicken Category
            {
                name: "Why Quicken",
                action: "Viewing Why Quicken",
                isMatch: () => window.location.pathname == "/why-quicken",
                contentZones: []
            },
            {
                name: "Manage Spending",
                action: "Viewing Manage Spending",
                isMatch: () => window.location.pathname == "/personal-finance/spending",
                contentZones: []
            },
            {
                name: "Create a Budget",
                action: "Viewing Create a Budget",
                isMatch: () => window.location.pathname == "/personal-finance/budget",
                contentZones: []
            },
            {
                name: "View and Pay Bills",
                action: "Viewing View and Pay Bills",
                isMatch: () => window.location.pathname == "/personal-finance/bills",
                contentZones: []
            },
            {
                name: "Plan for Retirement",
                action: "Viewing Plan for Retirement",
                isMatch: () => window.location.pathname == "/personal-finance/retirement",
                contentZones: []
            },
            {
                name: "Track Investments",
                action: "Viewing Track Investments",
                isMatch: () => window.location.pathname == "/personal-finance/investments",
                contentZones: []
            },
            {
                name: "Manage a Small Business",
                action: "Viewing Manage a Small Business",
                isMatch: () => window.location.pathname == "/personal-finance/home-business",
                contentZones: []
            },
            {
                name: "Property Management",
                action: "Viewing Property Management",
                isMatch: () => window.location.pathname == "/personal-finance/rental-property",
                contentZones: []
            },
            // Products Category
            {
                name: "Products Page",
                action: "Viewing Products Page",
                isMatch: () => window.location.pathname == "/products",
                contentZones: []
            },
            {
                name: "Products - Starter",
                action: "Viewing Products - Starter",
                isMatch: () => window.location.pathname == "/personal-finance/quicken-starter-windows",
                catalog: {
                    Product: {
                        _id: () => {
                            return Evergage.resolvers.fromSelectorAttribute(".show-price", "data-qkn-sku")();
                        },
                        sku: () => {
                            return Evergage.resolvers.fromSelectorAttribute(".show-price", "data-qkn-sku")();
                        },
                        name: "Quicken Starter",
                        price: () => {
                            return Evergage.resolvers.fromSelector(".show-price")();
                        }
                    }
                },
                contentZones: [],
                listeners: [
                    Evergage.listener("click", ".buy-btn-contain", () => {
                        let tempPrice = Evergage.resolvers.fromSelector(".price.show-price")();
                        let newPrice = parseFloat(tempPrice.split("$")[1]);
                        let tempID = Evergage.cashDom("span.price.show-price[data-qkn-sku]").attr("data-qkn-sku");
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
            ...
            {
                name: "Products - Deluxe",
                action: "Viewing Products - Deluxe",
                isMatch: () => window.location.pathname == "/personal-finance/quicken-deluxe-windows",
                onActionEvent: (actionEvent) => {
                    let prod = Evergage.resolvers.fromSelector("div.static-wrapper h1")();
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.attributes = actionEvent.user.attributes || {};
                    actionEvent.user.attributes.lastViewedProduct = prod;
                    return actionEvent;
                },
                catalog: {
                    Product: {
            ...
            {
                name: "Products - Premier",
                action: "Viewing Products - Premier",
                isMatch: () => window.location.pathname == "/personal-finance/quicken-premier-windows",
                onActionEvent: (actionEvent) => {
                    let prod = Evergage.resolvers.fromSelector("div.static-wrapper h1")();
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.attributes = actionEvent.user.attributes || {};
            ...
            {
                name: "Products - Home and Business",
                action: "Viewing Products - Home and Business",
                isMatch: () => window.location.pathname == "/personal-finance/quicken-home-business",
                onActionEvent: (actionEvent) => {
                    let prod = "Quicken Home and Business";
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.attributes = actionEvent.user.attributes || {};
                    actionEvent.user.attributes.lastViewedProduct = prod;
                    return actionEvent;
            ...
            {
                name: "Products - Quicken for Mac",
                action: "Viewing Products - Quicken for Mac",
                isMatch: () => window.location.pathname == "/products/quicken-mac",
                contentZones: []
            },
            {
                name: "Products - Simplifi",
                action: "Viewing Products - Simplifi",
                isMatch: () => window.location.pathname == "/simplifi/",
                onActionEvent: (actionEvent) => {
                    let prod = "Quicken Simplifi";
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.attributes = actionEvent.user.attributes || {};
                    actionEvent.user.attributes.lastViewedProduct = prod;
                    return actionEvent;
                ...
                contentZones: [],
                listeners: [
                    Evergage.listener("click", "div.pyp-annual-btns", () => {
                        let tempPrice = Evergage.cashDom(".pick-your-plan-container .data.nh-pricing .plans-wrapper .plan.annual-plan .data .span-wapper .value").text();
                        let newPrice = parseFloat(tempPrice);
                        let tempID = Evergage.resolvers.fromSelectorAttribute("#paypal-button-annual", "data-sku")();
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
                    ...
                    Evergage.listener("click", "div.pyp-monthly-btns", () => {
                        let tempPrice = Evergage.cashDom(".pick-your-plan-container .data.nh-pricing .plans-wrapper .plan.monthly-plan .data .span-wapper .value").text();
                        let newPrice = parseFloat(tempPrice);
                        let tempID = Evergage.resolvers.fromSelectorAttribute("#paypal-button-monthly", "data-sku")();
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
            ...
            {
                name: "Products - Quicken Simplifi",
                action: "Viewing Products - Quicken Simplifi",
                isMatch: () => window.location.pathname == "/personal-finance/quicken-simplifi",
            },
            {
                name: "Products - Quicken Simplifi - Features",
                action: "Viewing Products - Quicken Simplifi - Features",
                isMatch: () => window.location.pathname == "/simplifi/features/",
            },
            {
                name: "Products - Quicken Simplifi - Features - All Finances in One Place",
                action: "Viewing Products - Quicken Simplifi - Features - All Finances in One Place",
                isMatch: () => window.location.pathname == "/simplifi/features/all-finances-in-one-place",
            },
            {
                name: "Quicken Simplifi - Pick Your Plan",
                action: "Viewing Quicken Simplifi - Pick Your Plan Page",
                isMatch: () => window.location.pathname == '/simplifi/pick-your-plan',
            },
            {
                name: "Product Selector - Reverse NST",
                action: "Viewing Product Selector - Reverse NST",
                isMatch: () => window.location.pathname == "/product-selector/reverse-nst",
            },
            // Plans & Pricing Category
            {
                name: "Plans and Pricing",
                action: "Viewing Plans and Pricing",
                isMatch: () => window.location.pathname == "/product-selector",
                contentZones: [],
                listeners: [
                    Evergage.listener("click", ".psel-btn.simplifi", () => {
                        let tempPrice = Evergage.resolvers.fromSelector(".price.show-price")();
                        let newPrice = parseFloat(tempPrice.split("$")[1]);
                        let tempID = Evergage.cashDom("div.card.simplifi > div.price-section > p.price.show-price[data-qkn-sku]").attr("data-qkn-sku");
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
                    ...
                    Evergage.listener("click", ".psel-btn.starter", () => {
                        let tempPrice = Evergage.resolvers.fromSelector(".price.show-price")();
                        let newPrice = parseFloat(tempPrice.split("$")[1]);
                        let tempID = Evergage.cashDom("div.card.starter > div.price-section > p.price.show-price[data-qkn-sku]").attr("data-qkn-sku");
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
                    ...
                    Evergage.listener("click", ".psel-btn.deluxe", () => {
                        let tempPrice = Evergage.resolvers.fromSelector(".price.show-price")();
                        let newPrice = parseFloat(tempPrice.split("$")[1]);
                        let tempID = Evergage.cashDom("div.card.deluxe > div.price-section > p.price.show-price[data-qkn-sku]").attr("data-qkn-sku");
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
                    ...
                    Evergage.listener("click", ".psel-btn.premier", () => {
                        let tempPrice = Evergage.resolvers.fromSelector(".price.show-price")();
                        let newPrice = parseFloat(tempPrice.split("$")[1]);
                        let tempID = Evergage.cashDom("div.card.premier > div.price-section > p.price.show-price[data-qkn-sku]").attr("data-qkn-sku");
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
                    ...
                    Evergage.listener("click", ".psel-btn.hab", () => {
                        let tempPrice = Evergage.resolvers.fromSelector(".price.show-price")();
                        let newPrice = parseFloat(tempPrice.split("$")[1]);
                        let tempID = Evergage.cashDom("div.card.hab > div.price-section > p.price.show-price[data-qkn-sku]").attr("data-qkn-sku");
                        const lineItem = {
                            quantity: "1",
                            price: newPrice,
                            _id: tempID
            ...
            {
                name: "Resources Page",
                action: "Viewing Resources Page",
                isMatch: () => window.location.pathname == "/resources",
                contentZones: []
            },
            {
                name: "Resources - Getting Started",
                action: "Viewing Resources - Getting Started",
                isMatch: () => window.location.pathname == "/getting-started",
                contentZones: []
            },
            {
                name: "Blog - Finances 101: Tips on Opening a Savings Account",
                action: "Viewing Blog - Finances 101: Tips on Opening a Savings Account Page",
                isMatch: () => window.location.pathname == '/finances-101-tips-opening-savings-account',
                contentZones: []
            },
            // About Us
            {
                name: "About Us",
                action: "Viewing About Us Page",
                isMatch: () => window.location.pathname == '/about-us',
            },
            {
                name: "About Us - Careers",
                action: "Viewing About Us - Careers Page",
                isMatch: () => window.location.pathname == '/about-us/careers',
            },
            // Dynamic Blog Pages
            {
                name: "Resources - Quicken Blog List Pages",
                action: "Viewing Resources - Quicken Blog List Pages",
                isMatch: () => window.location.pathname == "/blog",
                contentZones: []
            },
            {
                name: () => {
                    let title = Evergage.resolvers.fromSelector(".post-title h1")();
                    // let title = Evergage.resolvers.fromSelector("#page-title")();
                    return `Resources - Quicken Blog - ${title}`;
                },
                action: () => {
                    let title = Evergage.resolvers.fromSelector(".post-title h1")();
                    return `Viewing Resources - Quicken Blog - ${title}`;
                },
                isMatch: () => {
                    return Evergage.DisplayUtils.pageElementLoaded("div.myctr", "html").then((ele) => {
                        let url = window.location.pathname.split("/")[1];
                        return url == "blog";
                    });
                },
            },
            // Resources - Investing Center
            {
                name: "Resources - Investing Center",
                action: "Viewing Resources - Investing Center",
                isMatch: () => window.location.pathname == "/investing/stock-quotes-investment-research/A",
                contentZones: []
            },
            {
                name: "Resources - Investing Center - Research Page",
                action: "Viewing Resources - Investing Center - Research Page",
                isMatch: () => window.location.pathname == '/investing/stock-quotes-investment-research',
                contentZones: []
            },
            // Dynamic Research Search Page
            {
                name: () => {
                    let sp = window.location.pathname.split("/")[3]
                    return `Resources - Investing Center - Research Page - ${sp}`
                },
                action: () => {
                    let sp = window.location.pathname.split("/")[3]
                    return `Viewing Resources - Investing Center - Research Page - ${sp}`
                },
                isMatch: () => {
                    if (window.location.pathname.split("/")[1] == 'investing') {
                        if (window.location.pathname.split("/")[2] == 'stock-quotes-investment-research') {
            ...
            {
                name: () => {
                    let title = Evergage.resolvers.fromSelector("#page-title")().trim();
                    return `Resources - Investing Center - ${title}`
                },
                action: () => {
                    let title = Evergage.resolvers.fromSelector("#page-title")().trim();
                    return `Viewing Resources - Investing Center - ${title}`;
                },
                isMatch: () => {
                    return window.location.pathname.split("/")[2] == 'stock-quotes';
                }
            },
            // Investing Center - Mutual Funds Dyanmic Pages
            {
                name: () => {
                    let title = Evergage.resolvers.fromSelector("span.current")().trim().split("-").join(" ");
                    return `Resources - Investing Center - Mutual Funds - ${title}`
                },
                action: () => {
                    let title = Evergage.resolvers.fromSelector("span.current")().trim().split("-").join(" ");
                    return `Viewing Resources - Investing Center - Mutual Funds - ${title}`;
                },
                isMatch: () => {
                    if (window.location.pathname.split("/").length > 2) {
                        if (window.location.pathname.split("/")[2] == 'mutual-funds') {
                            return true;
                        } else {
                            return false;
                        }
            ...
            // Calculator Pages
            {
                name: "Resources - Finance Calculators",
                action: "Viewing Resources - Finance Calculators",
                isMatch: () => window.location.pathname == "/resources/calculators",
                contentZones: []
            },
            {
                name: "Resources - Budget Calculator",
                action: "Viewing Resources - Budget Calculator Page",
                isMatch: () => window.location.pathname == '/resources/calculators/budget-calculator',
                contentZones: []
            },
            {
                name: "Resources - 401K Calculator",
                action: "Viewing Resources - 401K Calculator Page",
                isMatch: () => window.location.pathname == '/resources/calculators/401k-retirement-calculator',
                contentZones: []
            },
            {
                name: "Resources - Vacation Calculator",
                action: "Viewing Resources - Vacation Calculator Page",
                isMatch: () => window.location.pathname == '/resources/calculators/vacation-calculator',
                contentZones: []
            },
            // Support Category
            {
                name: "Support Page",
                action: "Viewing Support Page",
                isMatch: () => window.location.pathname == "/support" && window.location.pathname.split("/").length == 2,
                contentZones: []
            },
            {
                name: "Support - Windows FAQ Page",
                action: "Viewing Support - Windows FAQ Page",
                isMatch: () => window.location.pathname == '/windows-faq',
                contentZones: []
            },
            // Dynamic Support Pages
            {
                name: () => {
                    let title = Evergage.resolvers.fromSelector("#page-title")();
                    return `Support Page - ${title}`;
                },
                action: () => {
                    let title = Evergage.resolvers.fromSelector("#page-title")();
                    return `Viewing Support Page - ${title}`
                },
                isMatch: () => {
                    let temp = window.location.pathname
                    return temp.includes("support") && temp.split("/").length > 2 && !temp.includes("search")
                }
            },
            {
                name: "Support - Search Page",
                action: "Viewing Support - Search Page",
                isMatch: () => {
                    let temp = window.location.pathname.split("/")
                    return temp[1] == "support" && temp[2] == "search"
                }
            },
            {
                name: "Support - Download and Install",
                action: "Viewing Support - Download and Install",
                isMatch: () => window.location.pathname == "/activate",
                contentZones: []
            },
            // Shopping Cart
            {
                name: "Shopping Cart",
                action: "Viewing Shopping Cart Page",
                isMatch: () => window.location.pathname == "/shoppingcart/customer-info",
                listeners: [
                    Evergage.listener("click", "#edit-submit", () => {
                        const userEmail = Evergage.cashDom("#edit-email").val();
                        const userZip = Evergage.cashDom("#edit-zip").val();
                        Evergage.sendEvent({
                            action: "Entering Account Information for Purchase",
                            user: {
                                attributes: {
            ...
            },
            {
                ...
                isMatch: () => {
                    return Evergage.DisplayUtils.pageElementLoaded(".confirm-row-content", "html").then((ele) => {
                        let orderId = Drupal.settings.quickenCheckout.orderId
                ...
                catalog: {
                    Product: {
                        ...
                        lineItems: {
                            _id: () => {
                                let temp = []
                                let prodSku = Drupal.settings.quickenCheckout.purchased[0]
                                temp.push(prodSku);
                                return temp;
                            },
                            price: () => {
                                let temp = []
                                let prodSku = Drupal.settings.quickenCheckout.purchased[0]
                                let tempPrice = Drupal.settings.quickenCheckout.purchasePrice[prodSku]
                                temp.push(tempPrice);
                                return temp;
                            },
                            quantity: () => {
                                let temp = []
                                let qty = Drupal.settings.quickenCheckout.purchased.length
                                temp.push(qty);
                                return temp;
                            }
                        },
            ...
            {
                name: "Shopping Cart - Review",
                action: "Viewing Shopping Cart - Review Page",
                isMatch: () => window.location.pathname == '/shoppingcart/review'
            },
            {
                name: "Shopping Cart - Deferred Login",
                action: "Viewing Shopping Cart - Deferred Login Page",
                isMatch: () => window.location.pathname == '/shoppingcart/deferredlogin'
            },
            {
                name: "Shopping Cart - Login V2",
                action: "Viewing Shopping Cart - Login V2 Page",
                isMatch: () => window.location.pathname == '/shoppingcart/loginv2',
                listeners: [
                    Evergage.listener("click", ".BlueButton-sc-1uwk2j1-0", () => {
                        const email = Evergage.cashDom("#username").val();
                        const phoneN = Evergage.cashDom("#phone").val();
                        if (email) {
                            Evergage.sendEvent({
                                action: "User Login / Sign-up for Purchase",
                                user: {
                                    attributes: {
                                        emailAddress: email,
                                        phoneNumber: phoneN
            ...
            {
                name: "Landing Page Personalization - Campaign Page",
                action: "Viewing PPC Landing Page Personalization - Campaign Page",
                isMatch: () => window.location.pathname == "/ppc/non_brand",
                contentZones: [
                    { name: "landing_page_content_zone", selector: ".css-196a3qo" }
                ],
            },
            {
                name: "PPC Brand Test Page",
                action: "Viewing PPC Brand Test Landing Page",
                isMatch: () => window.location.pathname == "/ppc/brand_test",
                contentZones: [
                    { name: "landing_main_headline_1", selector: "#main-headline-1" },
                    { name: "landing_main_sub_head", selector: "#subheadline" },
                    { name: "landing_main_headline_2", selector: "#headline-2" },
                ],
            },
            {
                name: "PPC Personal Finance Page",
                action: "Viewing PPC Personal Finance Landing Page",
                isMatch: () => window.location.pathname == "/ppc/personal_finance",
                contentZones: [
                    { name: "landing_main_headline_1", selector: ".main-headline-1" },
                    { name: "landing_main_sub_head", selector: "#hero-list-1" },
                ],
            },
            // Simplifi PPC Landing Pages
            {
                name: "Simplifi PPC Landing Page",
                action: "Viewing Simplifi PPC Landing Page",
                isMatch: () => window.location.pathname == '/simplifi/ppc',
            },
            {
                name: "Simplifi PPC Landing Page - Mobile",
                action: "Viewing Simplifi PPC Landing Page - Mobile",
                isMatch: () => window.location.pathname == '/simplifi/ppc/mobile',
            },
            {
                name: "Simplifi PPC Landing Page - Non-Brand",
                action: "Viewing Simplifi PPC Landing Page - Non-Brand",
                isMatch: () => window.location.pathname == '/simplifi/ppc/nonbrand',
            },
            {
                name: "Simplifi PPC Landing Page - Non-Brand",
                action: "Viewing Simplifi PPC Landing Page - Non-Brand Test",
                isMatch: () => window.location.pathname == '/simplifi/ppc/nonbrand_test',
            },
            {
                name: "Simplifi PPC Landing Page - Brand",
                action: "Viewing Simplifi PPC Landing Page - Brand",
                isMatch: () => window.location.pathname == '/simplifi/ppc/brand',
            },
            // PPC Landing Pages
            {
                name: "PPC Landing Page - Offer Affiliate",
                action: "Viewing PPC Landing Page - Offer Affiliate",
                isMatch: () => window.location.pathname == '/ppc/offer-affiliate',
            },
            {
                name: "PPC Landing Page - Brand",
                action: "Viewing PPC Landing Page - Brand",
                isMatch: () => window.location.pathname == '/ppc/brand',
            },
            {
                name: "PPC Landing Page - Starter CA",
                action: "Viewing PPC Landing Page - Starter CA",
                isMatch: () => window.location.pathname == '/ppc/starter_ca',
            },
            {
                name: "PPC Landing Page - Rental Property",
                action: "Viewing PPC Landing Page - Rental Property",
                isMatch: () => window.location.pathname == '/ppc/rental_property',
            },
            {
                name: "PPC Landing Page - Investments",
                action: "Viewing PPC Landing Page - Investments",
                isMatch: () => window.location.pathname == '/ppc/investments',
            },
            {
                name: "PPC Landing Page - Deluxe",
                action: "Viewing PPC Landing Page - Deluxe",
                isMatch: () => window.location.pathname == '/ppc/deluxe',
            },
            {
                name: "PPC Landing Page - Deluxe Monthly Test",
                action: "Viewing PPC Landing Page - Deluxe Monthly Test",
                isMatch: () => window.location.pathname == '/ppc/deluxe-monthly-test',
            },
            {
                name: "PPC Landing Page - Premier",
                action: "Viewing PPC Landing Page - Premier",
                isMatch: () => window.location.pathname == '/ppc/premier',
            },
            {
                name: "PPC Landing Page - Home Business",
                action: "Viewing PPC Landing Page - Home Business",
                isMatch: () => window.location.pathname == '/ppc/home_business',
            },
            {
                name: "PPC Landing Page - Personal Finance",
                action: "Viewing PPC Landing Page - Personal Finance",
                isMatch: () => window.location.pathname == '/ppc/personal_finance',
            },
            {
                name: "PPC Landing Page - Personal Accounting Software",
                action: "Viewing PPC Landing Page - Personal Accounting Software",
                isMatch: () => window.location.pathname == '/ppc/personal_accounting_software',
            },
            {
                name: "PPC Landing Page - Home Accounting Software",
                action: "Viewing PPC Landing Page - Home Accounting Software",
                isMatch: () => window.location.pathname == '/ppc/home_accounting_software',
            },
            {
                name: "PPC Landing Page - Product Compare",
                action: "Viewing PPC Landing Page - Product Compare",
                isMatch: () => window.location.pathname == '/ppc/product_compare',
            },
            {
                name: "PPC Landing Page - Product Compare Mac",
                action: "Viewing PPC Landing Page - Product Compare Mac",
                isMatch: () => window.location.pathname == '/ppc/product_compare_mac',
            },
            {
                name: "PPC Landing Page - Starter",
                action: "Viewing PPC Landing Page - Starter",
                isMatch: () => window.location.pathname == '/ppc/starter',
            },
            {
                name: "PPC Landing Page - Deluxe Mac",
                action: "Viewing PPC Landing Page - Deluxe Mac",
                isMatch: () => window.location.pathname == '/ppc/deluxe_mac',
            },
            {
                name: "PPC Landing Page - Premier Mac",
                action: "Viewing PPC Landing Page - Premier Mac",
                isMatch: () => window.location.pathname == '/ppc/premier_mac',
            },
            {
                name: "PPC Landing Page - Starter Mac",
                action: "Viewing PPC Landing Page - Starter Mac",
                isMatch: () => window.location.pathname == '/ppc/starter_mac',
            },
            {
                name: "PPC Landing Page - Money Management",
                action: "Viewing PPC Landing Page - Money Management",
                isMatch: () => window.location.pathname == '/ppc/money_management',
            },
            {
                name: "PPC Landing Page - Bookkeeping",
                action: "Viewing PPC Landing Page - Bookkeeping",
                isMatch: () => window.location.pathname == '/ppc/bookkeeping',
            },
            {
                name: "PPC Landing Page - Bill Manager",
                action: "Viewing PPC Landing Page - Bill Manager",
                isMatch: () => window.location.pathname == '/ppc/billmanager',
            },
            {
                name: "PPC Landing Page - Win NF",
                action: "Viewing PPC Landing Page - Win NF",
                isMatch: () => window.location.pathname == '/ppc/win/nf',
            },
            {
                name: "PPC Landing Page - Deluxe Monthly",
                action: "Viewing PPC Landing Page - Deluxe Monthly",
                isMatch: () => window.location.pathname == '/ppc/deluxe-monthly',
            },
            {
                name: "PPC Landing Page - Affiliate Partners",
                action: "Viewing PPC Landing Page - Affiliate Partners",
                isMatch: () => window.location.pathname == '/ppc/affiliate-partners',
            },
            {
                name: "PPC Landing Page - Home Business Monthly",
                action: "Viewing PPC Landing Page - Home Business Monthly",
                isMatch: () => window.location.pathname == '/ppc/home_business_monthly',
            },
            // Email Landing Pages on Builder
            {
                name: "Email Landing Page - Upgrade 35",
                action: "Viewing Email Landing - Upgrade 35 Page",
                isMatch: () => window.location.pathname == '/em/upgrade-35',
            },
            {
                name: "Email Landing Page - Pulse V1",
                action: "Viewing Email Landing - Pulse V1 Page",
                isMatch: () => window.location.pathname == '/em/pulse-v1',
            },
            {
                name: "Email Landing Page - Pulse NRE",
                action: "Viewing Email Landing - Pulse NRE Page",
                isMatch: () => window.location.pathname == '/em/pulse-nre',
            },
            {
                name: "Email Landing Page - Pulse EX",
                action: "Viewing Email Landing - Pulse EX Page",
                isMatch: () => window.location.pathname == '/em/pulse-ex',
            },
            {
                name: "Email Landing Page - Pulse NFL",
                action: "Viewing Email Landing - Pulse NFL Page",
                isMatch: () => window.location.pathname == '/em/pulse-nfl',
            },
            {
                name: "Email Landing Page - Simplifi Savings Challenge",
                action: "Viewing Email Landing - Simplifi Savings Challenge Page",
                isMatch: () => window.location.pathname == '/simplifi/em/savings-challenge',
            },
            {
                name: "Email Landing Page - NFL - MP",
                action: "Viewing Email Landing - NFL - MP Page",
                isMatch: () => window.location.pathname == '/em/nfl-mp',
            },
            {
                name: "Email Landing Page - Upgrade 40",
                action: "Viewing Email Landing - Upgrade 40 Page",
                isMatch: () => window.location.pathname == '/em/upgrade-40',
            },
            // In Product Landing Pages
            {
                name: "In Product Landing Page - Windows 20",
                action: "Viewing Email Landing - Windows 20 Page",
                isMatch: () => window.location.pathname == '/ip/win/save20',
            },
            {
                name: "In Product Landing Page - Pulse",
                action: "Viewing Email Landing - Pulse Page",
                isMatch: () => window.location.pathname == '/ip/pulse',
            },
            {
                name: "In Product Landing Page - Pulse PPC Mobile Deluxe",
                action: "Viewing Email Landing - Pulse PPC Mobile Deluxe Page",
                isMatch: () => window.location.pathname == '/pulse/ppc/mobile/deluxe',
            },
            // TSM Landing Pages
            {
                name: "TSM Landing Page - 2022-20OFF V1",
                action: "Viewing TSM Landing Page - 2022-20OFF V1",
                isMatch: () => window.location.pathname == "/tsm/2022-20off-v1"
            },
            // Misc Pages
            {
                name: "Pros and Cons of Joint Accounts",
                action: "Viewing Pros and Cons of Joint Accounts Page",
                isMatch: () => window.location.pathname == '/pros-and-cons-joint-accounts-married-couples',
            },
            {
                name: "Tips to Stay Productive at Work",
                action: "Viewing Tips to Stay Productive at Work Page",
                isMatch: () => window.location.pathname == '/tips-stay-productive-work',
            },
            {
                name: "Biggest Expenses when Planning Wedding",
                action: "Viewing Biggest Expenses when Planning Wedding Page",
                isMatch: () => window.location.pathname == '/biggest-expenses-consider-when-planning-wedding',
            },
            {
                name: "What is Savings",
                action: "Viewing What is Savings Page",
                isMatch: () => window.location.pathname == '/what-savings',
            },
            {
                name: "Getting Started - Complete Guide for Quicken Windows",
                action: "Viewing Getting Started - Complete Guide for Quicken Windows Page",
                isMatch: () => window.location.pathname == '/complete-guide-getting-started-quicken-windows',
            },
            {
                name: "Stay Connected your Money",
                action: "Viewing Stay Connected your Money Page",
                isMatch: () => window.location.pathname == '/content/stay-connected-your-money',
            },
            {
                name: "Privacy - Delete User Info",
                action: "Viewing Privacy - Delete User Info Page",
                isMatch: () => window.location.pathname == '/privacy/us/delete-user-info',
            },
            {
                name: "Quicken Login",
                action: "Viewing Quicken Login Page",
                isMatch: () => window.location.pathname == '/quicken-login',
            },
            {
                name: "How to Use Quicken Mobile Companion App",
                action: "Viewing How to Use Quicken Mobile Companion App Page",
                isMatch: () => window.location.pathname == '/how-use-quicken-mobile-companion-app',
            },
            {
                name: "Child Care Costs vs Income",
                action: "Viewing Child Care Costs vs Income Page",
                isMatch: () => window.location.pathname == '/child-care-costs-vs-income',
            },
            {
                name: "Product Selector - Offer",
                action: "Viewing Product Selector - Offer Page",
                isMatch: () => window.location.pathname == '/product-selector/offer',
            },
            {
                name: "Personal Finance Tools - NFR - FI - Premier",
                action: "Viewing Personal Finance Tools - NFR - FI - Premier Page",
                isMatch: () => window.location.pathname == '/personal-finance-tools/nfr/fi/premier',
            },
            {
                name: "Quicken Activation - Existing",
                action: "Viewing Quicken Activation - Existing Page",
                isMatch: () => window.location.pathname == "/activation/existing"
            },
            {
                name: "Quicken Setup Activation",
                action: "Viewing Quicken Setup Activation Page",
                isMatch: () => window.location.pathname == "/setup/go"
            },
            // 404 Pages
            {
                name: "404 Page",
                action: "Viewing 404 Error Page",
                isMatch: () => window.location.pathname == '/404-page',
            }
        ]
    };
    const dataLayerCheckTransaction = () => {
        let check = window.dataLayer.filter((e) => {
            return e.event == "Transaction"
        })
        return check[0]
    }

    Evergage.initSitemap(sitemapConfig);
    console.log("Confirmation of Sitemap Initialization")
});
} catch (e) {
    if (typeof window.Evergage === "object" && typeof window.Evergage.getVersion === "function" && window.Evergage.getVersion() >= 5) {
